...
public class Util_DB {
    ...
    public Util_DB(Context appContext) {
    ...
    public ArrayList<ArrayList<String>> getslist(String key){
        ArrayList<ArrayList<String>> main = new ArrayList<>();
        ArrayList<String> all = getListString(key);

        for (int r = 0;r < all.size(); r++){
            String [] items = all.get(r).split(", ");

            ArrayList<String> temp = new ArrayList<>();
                for (int x = 0; x < items.length; x++){
                    String s = items[x].replace("[","").replace("]","");
    ...
    public void putslist(String key,ArrayList<ArrayList<String>> list){
